        ...
        if (opl.getModelDefinition().hasMain()) {
            ...
            if (opl.hasCplex()) {
                ...
                if (_cl.isRelaxation()) {
                    ...
                    opl.getCplex().setParam(IloCplex.DoubleParam.WorkMem, 200); /*comentar un rato */
                    /*opl.getCplex().setParam(IloCplex.IntParam.VarSel, 3);
                    opl.getCplex().setParam(IloCplex.BooleanParam.PreInd, false);
                    opl.getCplex().setParam(IloCplex.IntParam.MIPInterval, -1);
                    opl.getCplex().setParam(IloCplex.IntParam.BarDisplay, 2);
                    opl.getCplex().setParam(IloCplex.IntParam.ConflictDisplay, 2);
                    
                    /*opl.getCplex().setParam(IloCplex.IntParam.RowReadLim, 100);*/
                    
                    opl.getCplex().setParam(IloCplex.DoubleParam.TreLim, 8192); /*comentar un rato */
                    /*opl.getCplex().setParam(IloCplex.IntParam.NodeSel, 0);
                    opl.getCplex().setParam(IloCplex.IntParam.RootAlg, 0);
                    opl.getCplex().setParam(IloCplex.IntParam.NodeAlg, 4);
                    opl.getCplex().setParam(IloCplex.IntParam.HeurFreq, -1);
                    opl.getCplex().setParam(IloCplex.BooleanParam.MemoryEmphasis, true);
                    opl.getCplex().setParam(IloCplex.IntParam.MIPEmphasis, 1);
                    ...
                    /*opl.getCplex().setParam(IloCplex.IntParam.MIRCuts, -1);*/
                    //opl.getCplex().setParam(IloCplex.DoubleParam.EpGap, 0.8);
                   // opl.getCplex().setParam(IloCplex.IntParam.ItLim, 1000);
                    //opl.getCplex().setParam(IloCplex.IntParam.NodeLim, 5);
                    //opl.getCplex().setParam(IloCplex.IntParam.MIPSearch, 1);
...
class CommandLine {
    ...
    CommandLine(String[] args) {
        _verbose = false;
        if (args.length < 1) {
            /*_modelFileName = "C:\\Users\\SantiagoMiguel\\opl\\ILP3\\JL-ILP.mod";
            _dataFileNames.add("C:\\Users\\SantiagoMiguel\\opl\\ILP3\\JL-ILP.dat")*/;
        }
        int i = 0;
