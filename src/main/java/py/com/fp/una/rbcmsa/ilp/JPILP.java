...
public class JPILP {
    ...
    public static void main(String args[]) throws IOException {
        ...
        try {
            ...
            try {
                FileWriter fw = new FileWriter("C:\\Users\\SantiagoMiguel\\opl\\JPILP\\JPILP.dat");
                ...
                String argumentos[] = {"-v", "C:\\Users\\SantiagoMiguel\\opl\\JPILP\\JPILP.mod", "C:\\Users\\SantiagoMiguel\\opl\\JPILP\\JPILP.dat", "salidaCplexILP1.txt"};
                time_start = System.currentTimeMillis();
                
                OplRunILP.main(argumentos);
                
                time_end = System.currentTimeMillis();
                System.out.println("EL ILP 1 ha tomado " + (time_end - time_start) + " milisegundos");


            } catch (IOException ex) {
                Logger.getLogger(JPILP.class.getName()).log(Level.SEVERE, null, ex);
            }
